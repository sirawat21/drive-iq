...
var main = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var data, count, entries, category, limit, sortedData, filteredData, limitedData;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          category = "Weather";
          limit = "0"; // Sort data by desc of 'API' property value
          sortedData = sortByDESC(entries, "API"); // console.log(`DATA ` + entries[0]['API'])
